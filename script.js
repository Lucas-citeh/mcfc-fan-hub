...
const playerProfiles = {
    ...
    'Rodri': {
        description: "Ballon d'Or winner, World Cup winner, Premier League champion, Champions League winner. Played the full 120 minutes as Spain beat Argentina 1-0 AET (Ferran Torres 106') in the 2026 World Cup Final at MetLife Stadium on 19 July — one of the most decorated midfielders in football history. Now set to undergo back surgery with no confirmed return date; will miss the Asia Tour and likely the Community Shield. UPDATE 23 July: CityXtra and Read Man City report Real Madrid are growing in confidence over a summer move, with Rodri said to have opened the door to a transfer to Spain. City holding out for ~€100m. No official bid yet. Situation developing — contract renewal talks on hold.",
