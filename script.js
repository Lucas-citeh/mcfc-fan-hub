...
const playerProfiles = {
    ...
    'Rodri': {
        description: "Ballon d'Or winner, World Cup winner, Premier League champion, Champions League winner. Played the full 120 minutes as Spain beat Argentina 1-0 AET (Ferran Torres 106') in the 2026 World Cup Final at MetLife Stadium on 19 July — becoming one of the most decorated midfielders in football history. Now set to undergo back surgery before returning to Carrington. CityXtra report he may miss City's opening fixtures, with the Manchester derby (mid-September) cited as a potential return target; other outlets are more optimistic. Real Madrid will not pursue him this summer (Fabrizio Romano, June 2026). Contract renewal talks expected once he is back at Carrington.",
